...
{
    List<Music> itemlist = [
        Music(photo: "assets/images/casio.jpg",name: "Casio",detail: "YAMAHA PSR-F52 PORTABLE KEYBOARD WITH 61 KEYS",price: 7200,qty: 1),
    ...
    List<Music> cartlist = [Music(photo: "assets/images/tumbi.jpg",name: "Tumbi",detail: "SAI Musical Pure Handmade Tumbi",price: 650,qty: 1),];
